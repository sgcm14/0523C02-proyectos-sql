...
--
-- Host: 127.0.0.1    Database: proyecto_spotify
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `generoxc`
--

DROP TABLE IF EXISTS `generoxc`;
/*!50001 DROP VIEW IF EXISTS `generoxc`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `generoxc` AS SELECT 
 1 AS `idGeneroxCancion`,
 1 AS `IdCancion`,
 1 AS `IdGenero`*/;
...
--
-- Final view structure for view `generoxc`
--
...
/*!50001 VIEW `generoxc` AS select `generoxcancion`.`idGeneroxCancion` AS `idGeneroxCancion`,`generoxcancion`.`IdCancion` AS `IdCancion`,`generoxcancion`.`IdGenero` AS `IdGenero` from `generoxcancion` */;
...
-- Dump completed on 2022-09-10  0:36:07
